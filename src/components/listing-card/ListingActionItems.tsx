  ...
  return (
    <div className="listing-card__action-items">
        ...
        <svg height={32} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <g>
                <circle className="action-item__bg" cx="16" cy="16" r="16"/>
                <path className="action-item__heart-icon" d="M11.46,8.73a4.85,4.85,0,0,0-4.85,4.84c0,2.16.85,7.29,9.2,12.47a.95.95,0,0,0,1,0C25.15,20.86,26,15.73,26,13.57a4.85,4.85,0,0,0-4.85-4.84c-2.67,0-4.84,2.93-4.84,2.93S14.13,8.73,11.46,8.73Z"/>
            </g>
        </svg>
    </div>
  );
