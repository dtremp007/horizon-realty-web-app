...
// import { stringifyComparisonFunction } from "../../../lib/util";
// import FilterItem from "../../context/listingsContext/FilterItem";
...
// export const FilterElement = (filterParameter: FilterParameter) => {
//   const {
//     filterName,
//     filterType,
//     hasLegend,
...
//       comparisonOperator = "===";
//       targetField = e.currentTarget.value;
//     }
...
//     if (newValue === fallback || newValue === false) {
...
//     case "RangeSlider":
//       return (
//         <RangeSlider value={value} onChange={handleChange} {...filterProps} />
//       );
//     // data={label, value}[]
//     case "SegmentControl":
//       return (
